...
export class Hyp3eItemSheetV2 extends HandlebarsApplicationMixin(ItemSheetV2) {
  ...
  async _prepareContext(options) {
    ...
    if (this.item.type == "classTemplate") {
      ...
      const allArmor = [...CONFIG.HYP3E.armorList, ...CONFIG.HYP3E.shieldList].sort();
      ...
      context.weaponOptions = Object.fromEntries(CONFIG.HYP3E.weaponsList.map(n => [n, n]));
      ...
      context.gearOptions = Object.fromEntries(CONFIG.HYP3E.gearList.map(n => [n, n]));
      ...
      context.provisionOptions = Object.fromEntries(CONFIG.HYP3E.provisionsList.map(n => [n, n]));
      ...
      context.religiousOptions = Object.fromEntries(CONFIG.HYP3E.religiousList.map(n => [n, n]));
    }
