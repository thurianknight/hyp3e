...
//  */
// async function handleDamageRollButtons(html) {
...
//  * @returns {Boolean} - True if buttons were added, false if not
//  */
// async function handleDamageRoll2hButtons(html) {
...
//  * @returns {Boolean} - True if buttons were added, false if not
//  */
// async function handleApplyDamageButtons(html) {
...
//  */
// async function handleCritDamageButton(html) {
...
//  * @returns {Boolean} - True if button was added, false if not
//  */
// async function handleCritMissOrHitButtons(html) {
...
//  * @returns {Boolean} - True if button was added, false if not
//  */
// async function handleSaveButtons(html) {
//     // Saving throw button
...
//  * @returns {Boolean} - True if button was added, false if not
//  */
// async function handleEffectButtons(html) {
...
//  * @returns {Boolean} - True if button was added, false if not
//  */
// async function handleGenericDamageHealButtons(_msg, html) {
